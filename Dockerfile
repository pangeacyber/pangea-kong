...
# For OpenAI testing
# ENV KONG_DECLARATIVE_CONFIG_STRING='{"_format_version":"1.1", "services":[{"name":"test_service_openai","host":"api.openai.com","port":443,"protocol":"https", "routes":[{"name":"openairoutes","paths":["/"]}]}],"plugins":[{"name":"pangea_kong"}]}'
